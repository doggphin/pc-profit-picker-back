...
question = "Extract the PC components from the following description and return a Python dictionary. The dictionary keys must be 'cpu', 'gpu', 'memory', 'storage', 'powersupply', 'motherboard', and 'case'. Match each component to a real part name from PC Part Picker. If a component is missing from the description, set its value to None. The response must be only a valid Python dictionary—no explanations, text, or formatting outside the dictionary itself."
